...
$('#overlay_menu').on("animationend", function(){
  ...
  $('.overlay_contact_section').removeClass('fadeOut');
  ...
  if (isMenuOpen === true) {
    ...
    setTimeout(function () {
      $('.overlay_contact_section').show().addClass('animated fadeIn');}, 250
    );
   }
   else {
     ...
     $('#link5').css('opacity', '0');
     $('#link6').css('opacity', '0');
     $('.overlay_contact_section').css('opacity', '0');
     $('#link1').hide();
     $('#link2').hide();
     $('#link3').hide();
     $('#link4').hide();
...
$("#close_icon").click(function() {
  ...
  setTimeout(function () {
    $('.overlay_contact_section').addClass('animated fadeOut');}, 125
  );
  setTimeout(function () {
